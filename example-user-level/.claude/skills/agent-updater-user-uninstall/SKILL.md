...
description: Remove a package from the user-level agent-updater setup — reverse its installed files, delete its checkout, and drop it from the manifest. Invoke when the user asks to uninstall/remove a user-level package.
---
